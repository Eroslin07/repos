package com.newtouch.uctp.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.newtouch.uctp.framework.common.util.json.JsonUtils;
import com.newtouch.uctp.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from uctp-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author 芋道源码
 */
