package com.newtouch.uctp.framework.file.core.client.s3;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.uctp.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.uctp.iocoder.cn
        // 默认上海的 endpoint
