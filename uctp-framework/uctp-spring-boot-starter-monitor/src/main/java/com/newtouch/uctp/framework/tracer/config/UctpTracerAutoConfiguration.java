...
import com.newtouch.uctp.framework.tracer.core.aop.BizTraceAspect;
import com.newtouch.uctp.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "uctp.tracer", value = "enable", matchIfMissing = true)
public class UctpTracerAutoConfiguration {
