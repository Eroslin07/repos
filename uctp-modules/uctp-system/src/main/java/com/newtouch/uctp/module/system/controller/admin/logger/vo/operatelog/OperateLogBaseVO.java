package com.newtouch.uctp.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "Java 方法名", required = true, example = "com.newtouch.uctp.adminserver.UserController.save(...)")
