...
public interface  CarInfoConvert {
    ...
    AppSellCarInfoRespVO convertSell(CarInfoDO carInfo, List<String> carPicList, List<String> drivingPicList, List<String> registerPicList, CarInfoDetailsDO carInfoDetailsDO);
