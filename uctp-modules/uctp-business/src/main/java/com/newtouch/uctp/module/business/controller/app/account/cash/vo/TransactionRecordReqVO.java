...
public class TransactionRecordReqVO {
    ...
    @NotEmpty(message = "商户账户号不能未空",
            groups = {ValidatedGroup.Recharge.class, ValidatedGroup.Withdraw.class, ValidatedGroup.Reserve.class})
    ...
    @NotNull(message = "版本号不能为空",
            groups = {ValidatedGroup.Recharge.class, ValidatedGroup.Withdraw.class})
    private Integer revision;

    @Schema(description = "交易合同号")
    @NotEmpty(message = "交易合同号不能为空",
            groups = {ValidatedGroup.Reserve.class})
