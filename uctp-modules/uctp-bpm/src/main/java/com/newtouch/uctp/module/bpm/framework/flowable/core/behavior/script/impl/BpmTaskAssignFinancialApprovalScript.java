...
/**
 * @author helong
 * @date 2023/4/18 15:06
 */
@Component
public class BpmTaskAssignFinancialApprovalScript implements BpmTaskAssignScript {
    @Resource
    ...
    public Set<Long> calculateTaskCandidateUsers(DelegateExecution execution) {
        ...
        List<String> userList = bpmTaskAssignRuleMapper.getTaskAssignRulesByRoleCode("financial_approval");
    ...
    public BpmTaskRuleScriptEnum getEnum() {
        return BpmTaskRuleScriptEnum.FINANCIAL_APPROVAL;
    }
}
