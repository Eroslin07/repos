package com.newtouch.uctp.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.newtouch.uctp.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
