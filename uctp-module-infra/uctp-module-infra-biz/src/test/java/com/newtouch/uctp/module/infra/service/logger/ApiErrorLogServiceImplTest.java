...
import com.newtouch.uctp.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.newtouch.uctp.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.newtouch.uctp.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.newtouch.uctp.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.newtouch.uctp.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.newtouch.uctp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.newtouch.uctp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("uctp-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("uctp-test");
